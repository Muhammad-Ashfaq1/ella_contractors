                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            ...
                            <p class="text-muted">
                                Managing notes for contract:
                                <strong><?php echo htmlspecialchars($contract->subject ?? 'Unknown Contract'); ?></strong>
                            </p>
                        </div>
                        <div class="col-md-4 text-right">
                            ...
                            <a href="<?php echo admin_url('ella_contractors/view_contract/' . $contract_id); ?>"
                                class="btn btn-info">
                    ...
                    <div class="alert alert-warning">
                        ...
                        <p>The contract notes table has not been created yet. Please run the database migration to
                            create the required table.</p>
                        ...
                        <div class="col-md-3">
                            <div class="widget-card bg-info text-white">
                                <div class="widget-card-body">
                                    ...
                                    <div class="widget-card-content">
                                        <h3 class="widget-card-title"><?php echo count($notes_summary['by_type']); ?>
                                        </h3>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-striped table-hover">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr data-note-id="<?php echo $note->id; ?>">
                                                        <td>
                                                            <strong
                                                                class="text-primary"><?php echo htmlspecialchars($note->note_title); ?></strong>
                                                        </td>
                                                        <td>
                                                            <span
                                                                class="label label-info"><?php echo ucfirst($note->note_type); ?></span>
                                                        </td>
                                                        <td>
                                                            <div class="note-content" style="max-width: 300px;">
                                                                <?php 
                                                        ...
                                                        <td>
                                                            <small class="text-muted">
                                                                ...
                                                                <?php echo htmlspecialchars($note->created_by_name . ' ' . $note->created_by_lastname); ?>
                                                            </small>
                                                        </td>
                                                        <td>
                                                            <small class="text-muted">
                                                        ...
                                                        <td>
                                                            <div class="btn-group">
                                                                ...
                                                                <button type="button" class="btn btn-xs btn-info"
                                                                    onclick="viewNoteDetails(<?php echo $note->id; ?>)"
                                                                    title="View Details">
                                                                    <i class="fa fa-eye"></i>
                                                                </button>
                                                            </div>
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-md-12">
                                                <div class="alert alert-info">
                                                    ...
                                                    <?php echo count($notes); ?> note(s) found for this contract.
                                                    <?php if ($notes_summary['public'] > 0): ?>
                                                    <span class="ml-3"><i class="fa fa-eye"></i>
                                                        <?php echo $notes_summary['public']; ?> public</span>
                                                    <?php endif; ?>
                                                    <?php if ($notes_summary['private'] > 0): ?>
                                                    <span class="ml-3"><i class="fa fa-eye-slash"></i>
                                                        <?php echo $notes_summary['private']; ?> private</span>
                                                    <?php endif; ?>
                                                </div>
                                            </div>
                                        </div>
                ...
                <form id="noteForm">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="note_content" name="note_content" rows="6"
                                required></textarea>
                        </div>
    ...
    $(document).ready(function() {
        ...
        $('#noteForm').on('submit', function(e) {
            ...
            $.ajax({
                ...
                complete: function() {
                    $('#saveNoteBtn').prop('disabled', false).html(
                        '<i class="fa fa-save"></i> Save Note');
                }
            });
        });
