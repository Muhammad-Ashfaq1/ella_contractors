        ...
        <div class="panel_s">
            <div class="panel-body">
                            ...
                            <div class="col-md-6">
                                ...
                                <p class="text-muted">
                                    Contract: <strong><?= $contract->subject ?></strong> | 
                                    Number: <strong><?= $contract->contract_number ?></strong>
                                </p>
                            </div>
                    <div class="col-md-6 text-right">
                        <a href="<?= admin_url('ella_contractors/add_appointment/' . $contract_id) ?>" class="btn btn-info">
                ...
                <div class="row mb-3">
                    <div class="col-md-12">
                        <div class="alert alert-info">
                            <div class="row">
                                <div class="col-md-3">
                                    <strong>Client:</strong> <?= $contract->lead_name ?: 'N/A' ?>
                                </div>
                                <div class="col-md-3">
                                    <strong>Status:</strong> 
                                    <span class="label label-<?= $contract->status == 'active' ? 'success' : 'default' ?>">
                                        <?= ucfirst($contract->status) ?>
                                    </span>
                                </div>
                                <div class="col-md-3">
                                    <strong>Value:</strong> <?= $contract->contract_value ? '$' . number_format($contract->contract_value, 2) : 'N/A' ?>
                                </div>
                                <div class="col-md-3">
                                    <strong>Duration:</strong> 
                                    <?php if ($contract->start_date && $contract->end_date): ?>
                                        <?= date('M d', strtotime($contract->start_date)) ?> - <?= date('M d, Y', strtotime($contract->end_date)) ?>
                                    <?php else: ?>
                                        N/A
                                    <?php endif; ?>
                                </div>
                        ...
                        <tbody>
                            <?php if (!empty($appointments)): ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="label label-info"><?= ucfirst(str_replace('_', ' ', $appointment->appointment_type)) ?></span>
                                    </td>
                                    <td>
                                        <?php
                                        $status_class = '';
                            ...
                            <?php else: ?>
                                <tr>
                                    <td colspan="6" class="text-center">
                                        <p class="text-muted">No appointments found for this contract.</p>
                                        <a href="<?= admin_url('ella_contractors/add_appointment/' . $contract_id) ?>" class="btn btn-info">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="alert alert-success text-center">
                                    <h4><?= count(array_filter($appointments, function($a) { return $a->status == 'completed'; })) ?></h4>
                                    <p class="mb-0">Completed</p>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="alert alert-warning text-center">
                                    <h4><?= count(array_filter($appointments, function($a) { return $a->status == 'scheduled'; })) ?></h4>
                                    <p class="mb-0">Scheduled</p>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="alert alert-primary text-center">
                                    <h4><?= count(array_filter($appointments, function($a) { return $a->status == 'confirmed'; })) ?></h4>
