        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6">
                    ...
                    <p class="text-muted mb-0">Standard media files available for all contracts</p>
                </div>
                <div class="col-md-6 text-end">
                    <div class="d-flex align-items-center justify-content-end">
                        <div class="me-3">
                            <small class="text-muted d-block">Gallery Type</small>
                            <strong class="text-primary">Default Media</strong>
                        </div>
                        <div class="me-3">
    ...
    <div class="container">
        <div class="gallery-container">
            ...
            <p class="gallery-subtitle">
                Standard media files, images, and documents available for all contracts
            </p>
                            ...
                            <div class="media-info-section">
                                ...
                                <div class="text-center">
                                    <span class="media-default-badge">
                                        <i class="fas fa-star me-1"></i> Default Media
                                    </span>
                                </div>
                                
                                <!-- Action Buttons -->
                                <div class="media-actions">
                                    <a href="<?= site_url("default-media-gallery/{$hash}/view/{$media->file_name}") ?>" 
                                       target="_blank" class="media-btn media-btn-view">
                                        <i class="fas fa-eye"></i> View
                                    </a>
                                    <a href="<?= site_url("default-media-gallery/{$hash}/download/{$media->file_name}") ?>" 
            ...
            <?php else: ?>
                <div class="empty-state">
                    ...
                    <h3 class="empty-title">No Default Media Files Found</h3>
                    <p class="empty-description">
                        No default media files have been uploaded yet.
                    </p>
                </div>
            <?php endif; ?>
        </div>
